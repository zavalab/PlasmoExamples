...
plt_graph2 = Plots.plot(graph0,node_labels = true,markersize = 60,labelsize = 30,linewidth = 4,subgraph_colors = true,
layout_options = Dict(:tol => 0.001,:C => 2, :K => 4, :iterations => 5));
plt_matrix2 = Plots.spy(graph0,node_labels = true,subgraph_colors = true,markersize = 16);
